...
<li class="setting"><h2><a href="setting.php" title="Setting">Setting</a></li>
...
&nbsp;&nbsp;<br />
          <br />
		  <form name="msg" action="send_mail_action.php" method="post">
		  To :<br><br>

<input name="to" type="text" id="to" class="edit_box" value="<?php echo $_REQUEST['email_id']; ?>"><br>
 
<br>

		  Message: <br><br>

<textarea name="message" cols="50" rows="5" class="scrapbook_style"></textarea><br>

		  <input type="submit" value="Send mail" class="scrapbook_button"><br>
